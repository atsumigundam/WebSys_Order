...
<body>
	<div class="jumbotron">
		<div class="jumbocolor">
			...
			<p class="lead">このページはTカードを持っているお客様の情報を入力するページです</p>
		</div>
	</div>
	<div class="container">
		<div class="row">
			<div class="form-control col-sm-8 offset-sm-2">
				...
				<div class="row">
					...
					<form>
						<div class="row">
							<div class="cardpromote col-sm-8 offset-sm-2">
								<label>お客様情報を取得します</label>
							</div>
						</div>
						<div class="row">
							<div class="cardinfget col-sm-8 offset-sm-2"><label>カードをかざしてください</label>
							</div>
						</div>
						<div class="row">
